...
import depositando_cuenta from '../../images/intermedia/depositando_cuenta.png'

import { useNavigate } from 'react-router-dom';


function Deposito2_intermediate() {
    ...
    return (
        ...
        <Card style={{ width: 800, height: 550, background: 'white' }} className="p-1">
            ...
            <Row className="justify-content-center align-items-center">
                <Col xs="auto">
                    <h4>Depositando el efectivo</h4>
                </Col>
                <Col xs="auto">
                    <Image src={depositando_cuenta} style={{ width: '120px', height: 'auto' }} />
                </Col>
            </Row>
...
export default Deposito2_intermediate;