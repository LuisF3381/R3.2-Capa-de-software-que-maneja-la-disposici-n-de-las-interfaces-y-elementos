...
import consultando_cuenta from '../../images/intermedia/consultando_cuenta.png'

import { useNavigate } from 'react-router-dom';


function Consulta_intermediate() {
    ...
    return (
        ...
        <Card style={{ width: 800, height: 550, background: 'white' }} className="p-1">
            ...
            <Row className="justify-content-center align-items-center">
                <Col xs="auto">
                    <h4>Consultando cuenta</h4>
                </Col>
                <Col xs="auto">
                    <Image src={consultando_cuenta} style={{ width: '120px', height: 'auto' }} />
                </Col>
            </Row>
...
export default Consulta_intermediate;